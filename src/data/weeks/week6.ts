...
export const week6: Week = {
  ...
  "coreConcepts": [
    "Real-time corrections during dynamic movement"
  ],
  "focusAreas": [
    {
      "title": "Overview",
      "description": "Shifting focus to the lower extremities, gait analysis, and the dynamic skill of corrective feedback. Providing real-time corrections during weight-bearing movements is one of the most cognitively demanding linguistic tasks, requiring rapid, authoritative syntax."
    }
  ],
  "vocabTables": [
    {
  ...
  "checkpoints": [
    ...
    {
      "id": "w6-c2",
      "label": "Practiced the vocal intonation of abruptly stopping a patient and providing corrective redirection."
    },
    {
      "id": "w6-c3",
  ...
  "scenario": {
    "patient": "A post-op ACL reconstruction patient is performing a mini-squat incorrectly, allowing their knee to collapse inward into dangerous valgus. Urgently tell them to stop, inform them the pattern is wrong, instruct them to move only the knee straight forward, and ask them to perform the repetition again, but slowly.",
    "instructions": "Formulate the rapid sequence of corrective commands in Arabic. The tone must be authoritative enough to stop the dangerous movement immediately, yet instructive enough to guide the correction. Provide script and transliteration.",
    "answerKey": {
      "arabic": "وقف لا تسوي كذا، هذاك غلط. حرّك فقط ركبتك قدام. سوي مرة ثانية، بطيء.",
      "transliteration": "Woqaff! La thisouvi qida, haadak galath. Har'rik faqath rukbathek kaddaam. Souvi maara thania, bathayi.",
      "rationale": "Woqaff! followed by La thisouvi qida, haadak galath provides immediate feedback to halt the kinetic chain. Har'rik faqath rukbathek kaddaam gives a precise external spatial target using the modifier Kaddaam (forward) to prevent valgus collapse. Concluding with Souvi maara thania plus the speed modifier bathayi (slowly) restores motor control and cognitive focus."
    }
  }
};
