...
export const week7: Week = {
  ...
  "coreConcepts": [
    "Prescribing sets, reps & driving compliance"
  ],
  "focusAreas": [
    {
      "title": "Overview",
      "description": "Clinical efficacy relies on compliance outside the clinic. This module covers explaining protocols, prescribing exact sets and reps, describing resistance equipment, and detailing the physiological rationale to ensure profound patient buy-in."
    }
  ],
  "vocabTables": [
    {
    ...
    },
    {
      ...
      "rows": [
        ...
        [
          ...
          "ثقيل",
          "Thakayil",
          "Used when prescribing weighted resistance training."
        ]
      ]
    },
    {
  ...
  "checkpoints": [
    {
      "id": "w7-c1",
      "label": "Accurately translated a standard '3 sets of 10 reps, twice a day' protocol into colloquial Arabic."
    },
    {
      "id": "w7-c2",
  ...
  "scenario": {
    "patient": "A patient with subacromial shoulder impingement needs to begin an active rotator cuff strengthening program. First explain the rationale — that their shoulder muscles are weak and require strengthening. Then instruct the patient to perform a specific light resistance band exercise 10 times, and to repeat that set again.",
    "instructions": "Write the educational rationale and the exact exercise prescription in conversational Arabic. Ensure the tone is educational and encouraging, driving patient compliance. Provide both script and transliteration.",
    "answerKey": {
      "arabic": "عضلات كتفك ضعيف، لازم تقوية. هذا تمرين بسيط. سوي عشرة مرات، وكرر مرة ثانية.",
      "transliteration": "Adaalat kethifek d'ayif, laazim thak'viath. Haada thamreen baseeth. Souvi ashra maarath, wa ker'r maara thania.",
      "rationale": "Beginning with the pathology — Adaalat kethifek d'ayif — establishes clear medical necessity, and laazim thak'viath provides the biomechanical solution. Categorizing the movement as a thamreen baseeth (light exercise) reduces anxiety and fear-avoidance. Souvi ashra maarath and ker'r deliver the exact dosimetric parameters required for an effective HEP."
    }
  }
};
